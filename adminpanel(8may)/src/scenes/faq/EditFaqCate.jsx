    ...
    const fetchFaqcate = async () => {
        ...
        try {
            const res = await axios.get(
                `${process.env.REACT_APP_BASE_URL}/api/v1/faq/getSinglefaqCate?category_Id=${id}`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(
                `${process.env.REACT_APP_BASE_URL}/api/v1/faq/updateSinglefaqCate?category_Id=${id}`, {
                cate_name: title,
                ...
                >
                    ...
                    >
                        <form onSubmit={handleSubmit}>
                            <Card>
                                <Box m="15px 0 0 15px">
                                    <Header subtitle={"Edit Category"} title="FAQs Category" />
                                    <Divider />
                                    <CardContent>
