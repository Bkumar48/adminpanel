    ...
    const fetchFaq = async () => {
        ...
        try {
            const res = await axios.get(
                `${process.env.REACT_APP_BASE_URL}/api/v1/faq/getSinglefaq?faqId=${id}`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(
                `${process.env.REACT_APP_BASE_URL}/api/v1/faq/updateFaq?faqId=${id}`, {
                title: title,
            ...
            navigate('/faqs/faqlist', { replace: true });
        } catch (error) {
