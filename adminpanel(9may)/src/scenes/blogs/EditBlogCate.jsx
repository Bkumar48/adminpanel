...
const EditBlog = () => {
    ...
    const getBlog = async () => {
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_BASE_URL}/api/v1/user/blog/singleBlog?id=${id}`,
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(false);
      await axios.put(
        `${process.env.REACT_APP_BASE_URL}/api/v1/user/blog/updateBlog?id=${id}`,
  ...
  //     try {
  //       const res = await axios.get(
  //         `${process.env.REACT_APP_BASE_URL}/api/v1/user/all-users`,
  //         {
  //           headers: {
  //             Authorization: `Bearer ${sessionStorage.getItem("token")}`,
  //           },
